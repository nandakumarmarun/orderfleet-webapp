$(document).ready(function() {
	...
	dtVisits = $('#dtVisits').dataTable({
		"bSort" : false,"aLengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]]
	} );
...
/* Serching Day,YesterDay,WTD,MTD */
function filter() {
	...
	if ($('#dbExecutive').val() == "-1") {
		customAlert("Please Select Executive");
	...
	$.ajax({
		url : contextPath + "/company/executiveWiseFilterVisits",
		type : 'GET',
		data : {
...
function onDateChange() {
	...
	console.log($('#dbExecutive').val());
	$.ajax({
		url : contextPath + "/company/filterExecutiveWiseVisits",
		type : 'GET',
		data : {
			id : $("#dbExecutive").val(),
