...
if (!this.LocationWiseSalesComparisonReport) {
	this.LocationWiseSalesComparisonReport = {};
}

(function () {
	'use strict';

	var locationWiseSalesComparisonReportContextPath = location.protocol + '//' +
	...
	function loadLocationWiseTargetAchievedReport() {
		...
		$.ajax({
			url: locationWiseSalesComparisonReportContextPath + "/load-data",
			type: 'GET',
			data: {
