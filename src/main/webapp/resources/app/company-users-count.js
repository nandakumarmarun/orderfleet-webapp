if (!this.CompanyUsersCount) {
	this.CompanyUsersCount = {};
}
...
(function() {
	...
	var companyUsersCountContextPath = location.protocol + '//' + location.host
			+ location.pathname;
	 ...
	 function getActivatedUser()
	{
		...
		$.ajax({
			url : companyUsersCountContextPath + "/loadUserCount",
			type : "GET",
			data : {
				companyId : companyid
				},
	 ...
	 function getAllCompaniesUser()
		{
			...
			$.ajax({
				url : companyUsersCountContextPath + "/loadAll",
				type : "GET",
	...
	function onSaveSuccess(result) {
		...
		window.location = companyUsersCountContextPath;
	}
