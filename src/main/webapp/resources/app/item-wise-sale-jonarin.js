...
(function() {
	...
	ItemWiseSale.filter = function() {
		...
		if (value == "no") {
			$('#tHeadItemWiseSale')
					.html(
							"<tr><th>Date</th><th>OderID</th><th>Employee</th><th>Receiver Account Profile</th><th>Supplier Account Profile</th><th>Customer Location</th><th>Source</th><th>Destination</th><th>Category</th><th>Item</th><th>ProductGroup</th><th>Territory</th><th>DeliveryDate</th><th>SaleOrderStatus</th><th>Quantity</th><th>Amount</th></tr>");
			$('#tBodyItemWiseSale')
					.html(
			...
			$('#tHeadItemWiseSale')
					.html(
							"<tr><th>Date</th><th>OderID</th><th>Employee</th><th>Receiver Account Profile</th><th>Supplier Account Profile</th><th>Customer Location</th><th>Category</th><th>Item</th><th>ProductGroup</th><th>Territory</th><th>DeliveryDate</th><th>SaleOrderStatus</th><th>Quantity</th><th>Unit Quantity</th><th>Voulume</th><th>Rate</th><th>Amount(tax,disc,etc..)</th></tr>");
			$('#tBodyItemWiseSale')
					.html(
