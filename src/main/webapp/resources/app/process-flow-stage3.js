...
InventoryVoucher.updateRemarks = function(ivhPid) {
	...
	InventoryVoucher.filter = function() {
		...
		$
				.ajax({
					...
					type : 'GET',
					data : {
						processFlowStatus : "PO_ACCEPTED_AT_TSL",
	...
	function spanProcessFlowStatus(inventoryVoucherPid, status) {
		...
		var poPlacedAtTsl = "'" + 'PO_ACCEPTED_AT_TSL' + "'";
		...
		case 'DEFAULT':
			spanProcessFlowStatus = '<div class="dropdown"><span class="label label-default dropdown-toggle" data-toggle="dropdown" style="cursor: pointer;">'
					...
					+ ','
					+ underProduction
					+ ')" style="cursor: pointer;"><a>UNDER_PRODUCTION</a></li>'
					+ '</ul></div>';
			break;
		...
		case 'UNDER_PRODUCTION':
			spanProcessFlowStatus = '<div class="dropdown"><span class="label label-default dropdown-toggle" data-toggle="dropdown" style="cursor: pointer;">'
					+ 'UNDER_PRODUCTION <span class="caret"></span></span>'
					+ '<ul class="dropdown-menu">'
					+ '<li onclick="InventoryVoucher.setProcessFlowStatus('
					+ pid
					+ ','
					+ poPlacedAtTsl
					+ ')"  style="cursor: pointer;"><a>PO_ACCEPTED_AT_TSL</a></li>'
					+ '</ul></div>';
			break;
		}
