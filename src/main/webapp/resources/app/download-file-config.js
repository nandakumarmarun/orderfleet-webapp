if (!this.DownloadFileConfig) {
	this.DownloadFileConfig = {};
}
var Users = new Array();
var list = new Array();
(function() {
	...
	$(document).ready(function() {
		...
		//DownloadFileConfig.getUserDeviceKey();
	...
	var downloadFileConfigContextPath = location.protocol + '//' + location.host
			+ location.pathname;
	...
	DownloadFileConfig.getUserDeviceKey = function() {
		...
		$
				.ajax({
					url : downloadFileConfigContextPath + "/filter",
					type : "GET",
					data : {
	...
	DownloadFileConfig.saveUserDeviceKey = function() {
		var i = 0;
		...
		$.ajax({
			url : downloadFileConfigContextPath + "/update",
	...
	function onSaveSuccess(result) {
		...
		window.location = downloadFileConfigContextPath;
	}
