...
<title>SalesNrich | UserCreated Account Profile</title>
<style type="text/css">
.error {
	color: red;
}
...
<body class="page-body" data-url="">
	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<hr />
			<h2>User Created Account Profile</h2>
			<div class="row">
				<div class="col-sm-1">
					<input name='includeInactive' id="includeInactive" type='checkbox'
						value='no' onchange="UserCreatedAccountProfile.filter();" />
					Include Inactive
				</div>
				<div class="col-sm-2">
				...
				<div class="col-sm-2">
					Account Types<select id="dbAccountType" name="accountTypePid"
						class="form-control">
						<option value="no">All Account Type</option>
				...
				<div class="col-sm-2">
					<br /> <select class="form-control" id="dbDateSearch"
						onchange="UserCreatedAccountProfile.showDatePicker()">
				...
				<div class="col-sm-1">
					...
					<button type="button" class="btn btn-info"
						onclick="UserCreatedAccountProfile.filter()">Apply</button>
				</div>
			</div>
			<br>
			...
			<div class="row">
				<div class="col-sm-2">
					<br />
					<label style="color: black;">Count : </label> <label style="color: black;" id="lblCount">0</label>
				</div>
				<div class="col-sm-4">
			...
			<div class="table-responsive">
				<table class="table  table-striped table-bordered"
					...
					<tbody id="tBodyUserCreatedAccountProfile">
	...
	<spring:url value="/resources/app/user-created-accountprofile.js"
		var="userCreatedAccountProfileJs"></spring:url>
	<script type="text/javascript" src="${userCreatedAccountProfileJs}"></script>
</body>
</html>