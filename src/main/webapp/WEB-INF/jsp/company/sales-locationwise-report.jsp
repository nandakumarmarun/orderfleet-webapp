...
<title>SalesNrich | Location Wise Sales</title>
...
<body class="page-body" data-url="">
	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<hr />
			<h2>Sales Performance Location Wise</h2>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select class="form-control" id="dbDateSearch"
									onchange="LocationSalesTargetAchievedReport.showDatePicker()">
									<option value="TYR">This Year</option>
									<option value="LYR">Last Year</option>
									<option value="TMT">This Month</option>
									<option value="LMT">Last Month</option>
									<!-- <option value="TWK">This Week</option>
							...
							<div class="col-sm-3">
								<select id="dbDisplayMode" name="displayMode"
									class="form-control">
									<option value="QuarterWise">Quarterly</option>
			...
			<div style="overflow: auto; min-height: 300px;">
				<table style="display: none;"
					...
					<thead>
						<tr>
							<th rowspan="2"
								style="text-align: center; color: white; background-color: rgb(48, 54, 65); font-weight: bold; vertical-align: middle;">PRODUCT GROUP</th>
	...
	<spring:url value="/resources/app/sales-locationwise-report.js"
		var="salesLocationwiseReportJs"></spring:url>
	<script type="text/javascript" src="${salesLocationwiseReportJs}"></script>
</body>
</html>