...
<title>SalesNrich | Competitor Price Trends Chart</title>
...
<body class="page-body" data-url="">
	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<hr />
			<h2>Competitor Price Trends Chart</h2>
	...
	<spring:url value="/resources/app/competitor-price-trend-chart.js"
		var="competitorPriceTrendsChartJs"></spring:url>
	<script type="text/javascript" src="${competitorPriceTrendsChartJs}"></script>
