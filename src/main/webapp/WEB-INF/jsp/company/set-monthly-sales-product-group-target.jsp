...
<body class="page-body" data-url="">
	<div class="page-container">
		...
		<div class="main-content">
			...
			<hr />
			<h2>Set Monthly Sales Target</h2>
				...
				<div class="col-md-12 col-sm-12 clearfix">
					<form role="form" class="form-horizontal form-groups-bordered">
						<div class="form-group">
							...
							<div class="col-sm-2">
								<button id="btnApplyMonthlySales" type="button" class="btn btn-info">Apply</button>
							</div>
						</div>
					</form>
				</div>
					...
					<div class="modal-content">
						...
						<div class="modal-footer">
							<input class="btn btn-success" type="button" id="saveTarget"
								value="Save" onclick="SetMonthlySalesProductGroupTarget.saveTarget()" />
	...
	<spring:url value="/resources/app/set-monthly-sales-product-group-target.js"
