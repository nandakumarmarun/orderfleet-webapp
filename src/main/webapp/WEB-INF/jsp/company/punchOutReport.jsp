...
<title>SalesNrich | PunchOut Report</title>
...
<body class="page-body" data-url="">
	...
	<div class="page-container">
		...
		<div class="main-content">
						...
						<div class="form-group">
							...
							<div class="col-sm-1">
								<button type="button" class="btn btn-info"
									onclick="PunchOutReport.filter()">Apply</button>
							</div>
							<div class="col-sm-2">
			...
			<table class="table  table-striped table-bordered"
				...
				<tbody id="tBodyPunchOutReport">
				</tbody>
			</table>
			<hr />
			<!-- Footer -->
			<jsp:include page="../fragments/m_footer.jsp"></jsp:include>
			<spring:url value="/web/punchOut-report" var="urlPunchOutReports"></spring:url>
		</div>
	</div>
	...
	<spring:url value="/resources/app/punchOut-report.js"
		var="punchOutReportJs"></spring:url>
	<script type="text/javascript" src="${punchOutReportJs}"></script>
</body>
</html>