...
<body class="page-body" data-url="">
	<div class="page-container">
		...
		<div class="main-content">
			...
			<hr />
			<h2>Set Monthly Activity Target</h2>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<input type="hidden" id="hdnActivityPid" />
							<input type="hidden" id="hdnUserActivityTargetPid" />
							<div class="form-group">
						...
						<div class="modal-footer">
							<input class="btn btn-success" type="button" id="saveTarget"
								value="Save" onclick="SetActivityTarget.saveTarget()" />
	...
	<spring:url value="/resources/app/set-activity-target.js"
		var="setActivityTargetJs"></spring:url>
	<script type="text/javascript" src="${setActivityTargetJs}"></script>
</body>
</html>