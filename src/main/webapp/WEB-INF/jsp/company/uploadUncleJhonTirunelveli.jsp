...
<body class="page-body" data-url="">
	<div class="page-container">
		...
		<div class="main-content">
			...
			<hr />
			<h2>Sync Masters Tirunelveli</h2>
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered">
					...
					<tbody>
						<tr>
							<td><input class="check-one" name='uploadMasters'
								type="checkbox" value="product_profiles"></input></td>
	...
	<spring:url value="/resources/app/upload-uj-tirunelveli.js"
		var="uploadunclejhonJs"></spring:url>
