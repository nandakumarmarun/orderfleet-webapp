...
<title>SalesNrich | Document Product Groups</title>
<style type="text/css">
.error {
	color: red;
}
...
<body class="page-body" data-url="">
						...
						<tr class="${loopStatus.index % 2 == 0 ? 'odd' : 'even'}">
							...
							<td>
								<button type="button" class="btn btn-info"
									onclick="DocumentProductGroup.showModalPopup($('#productGroupsModal'),'${user.pid}',0);">Assign
	...
	<spring:url value="/resources/app/document-product-group.js"
		var="documentProductGroup"></spring:url>
	<script type="text/javascript" src="${documentProductGroup}"></script>
