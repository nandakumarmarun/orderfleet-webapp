...
<title>SalesNrich | Sales Group Target Achieved Summary</title>
...
<body class="page-body" data-url="">
	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<hr />
			<h2>Sales Group Target Achieved Summary</h2>
	...
	<spring:url value="/resources/app/sales-group-target-achieved-total.js"
		var="salesGroupTargetAchievedTotalJs"></spring:url>

	<script type="text/javascript" src="${salesGroupTargetAchievedTotalJs}"></script>
