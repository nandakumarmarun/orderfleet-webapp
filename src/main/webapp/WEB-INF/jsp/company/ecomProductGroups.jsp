...
<title>SalesNrich | EcomProductGroups</title>
</head>
<body class="page-body" data-url="">
	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<hr />
			<h2>Ecom Product Groups</h2>

			<div class="row col-xs-12">
				<div class="pull-right">
					<button type="button" class="btn btn-success"
						onclick="EcomProductGroup.showModalPopup($('#assignTaxModal'));">Assign
						Tax</button>
					<button type="button" class="btn btn-success"
						onclick="EcomProductGroup.showModalPopup($('#assignUnitQtyModal'));">Assign
						Unit Qty</button>
					<button type="button" class="btn btn-success"
						onclick="EcomProductGroup.showModalPopup($('#myModal'));">Create
						new Ecom-Product Group</button>
				</div>
			</div>
			<br> <br>
			<div class="row col-xs-12">
				...
				<div class="pull-right">
					<button type="button" class="btn"
						onclick="EcomProductGroup.showModalPopup($('#enableProductGroupModal'));">Deactivated
						EcomProductGroup</button>
				</div>
			</div>
					...
					<c:forEach items="${pageProductGroup}" var="productGroup"
						...
						<tr class="${loopStatus.index % 2 == 0 ? 'odd' : 'even'}">
							...
							<td><span
								...
								onClick="EcomProductGroup.setActive('${productGroup.name}','${productGroup.pid}', '${!productGroup.activated}')"
							...
							<td><span
								...
								onClick="EcomProductGroup.setThirdpartyUpdate('${productGroup.name}','${productGroup.pid}', '${!productGroup.thirdpartyUpdate}')"
								style="cursor: pointer;">${productGroup.thirdpartyUpdate ? "TRUE" : "FALSE"}</span>
							</td>
							<td>
								<button type="button" class="btn btn-blue"
									onclick="EcomProductGroup.showModalPopup($('#viewModal'),'${productGroup.pid}',0);">View</button>
								<button type="button" class="btn btn-blue"
									onclick="EcomProductGroup.showModalPopup($('#myModal'),'${productGroup.pid}',1);">Edit</button>
								<button type="button" class="btn btn-danger"
									onclick="EcomProductGroup.showModalPopup($('#deleteModal'),'${productGroup.pid}',2);">Delete</button>
								<%-- <button type="button" class="btn btn-info"
									onclick="EcomProductGroup.showModalPopup($('#productsModal'),'${productGroup.pid}',3);">Assign
									Products</button> --%>
								<button type="button" class="btn btn-info"
									onclick="EcomProductGroup.showModalPopup($('#ecomProductsModal'),'${productGroup.pid}',4);">Assign
			...
			<spring:url value="/web/ecomProductGroups" var="urlProductGroup"></spring:url>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="viewModalLabel">Ecom Product Group</h4>
							</div>
							<div class="modal-body">
								<div class="modal-body" style="overflow: auto;">
									<!-- error message -->
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<div class="modal-body" style="overflow: auto;">
									...
									<p>Are you sure you want to delete this Ecom Product Group?</p>
								</div>
							</div>
							<div class="modal-footer">
								<div class="modal-footer">
...
<%-- 			<div class="modal fade container" id="productsModal">
									...
									<div class="col-md-12">
										...
										<div class="search-results-panes">
											<div class="search-results-pane" id="commonTax"
												style="display: block;">
												<div class="form-group">
													<label class="control-label" for="field_alias">Ecom Product
														...
														<c:forEach items="${taxMasters}" var="taxMaster">
															<tr id="taxcheck">
																<td><input name='taxMaster'
																	onchange='EcomProductGroup.loadProductGroups();'
	...
	<spring:url value="/resources/app/ecom-product-group.js"
		var="ecomProductGroupJs"></spring:url>
	<script type="text/javascript" src="${ecomProductGroupJs}"></script>
</body>
</html>