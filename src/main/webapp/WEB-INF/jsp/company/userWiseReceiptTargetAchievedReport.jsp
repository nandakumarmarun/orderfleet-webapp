...
<title>SalesNrich | User Wise Receipt Target Vs Achieved Report</title>
...
<body class="page-body" data-url="">
	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<hr />
			<h2>User Wise Receipt Target Vs Achieved Report</h2>
			...
			<div style="overflow: auto; min-height: 300px;">
				<table style="display: none;"
					...
					id="tblUserWiseReceiptTargetAchievedReport">
					<thead>
						<tr>
							<th rowspan="2"
	...
	<spring:url value="/resources/app/user-wise-receipt-target-achieved-report.js"
		var="userWiseReceiptTargetAchievedReportJs"></spring:url>
	<script type="text/javascript" src="${userWiseReceiptTargetAchievedReportJs}"></script>
