...
<title>SalesNrich | Post Dated Vouchers</title>
<style type="text/css">
.error {
	color: red;
}
...
<body class="page-body" data-url="">
		...
		<div class="main-content">
			...
			<div class="table-responsive">
				<table class="collaptable table table-striped table-bordered">
					...
					<tbody id="tBodyPostDatedVoucher">
	...
	<spring:url value="/resources/app/post-dated-voucher.js"
		var="postDatedVoucherJs"></spring:url>
	<script type="text/javascript" src="${postDatedVoucherJs}"></script>
</body>
</html>