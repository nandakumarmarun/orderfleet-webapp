...
<title>SalesNrich | CustomerGroup Target Report</title>
...
<body class="page-body" data-url="">
	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<hr />
			<h2>CustomerGroup Target Report</h2>
			...
			<div style="overflow: auto; min-height: 300px;">
				<table style="display: none;"
					...
					id="tblUserCustomerGroupTargetAchievedReport">
					<thead>
						<tr>
							<th rowspan="2"
								style="text-align: center; color: white; background-color: rgb(48, 54, 65); font-weight: bold; vertical-align: middle;">CUSTOMER GROUP</th>
	...
	<spring:url value="/resources/app/user-customerGroup-target-achieved-report.js"
		var="userCustomerGroupTargetAchievedReportJs"></spring:url>
	<script type="text/javascript" src="${userCustomerGroupTargetAchievedReportJs}"></script>
