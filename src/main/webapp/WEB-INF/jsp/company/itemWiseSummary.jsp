...
<title>SalesNrich | Item Wise Summary</title>
<style type="text/css">
.error {
	color: red;
}
...
<body class="page-body" data-url="">
						...
						<div class="form-group">
							...
							<div class="col-sm-1">
								...
								<button type="button" class="btn btn-info"
									onclick="ItemWiseSummary.filter()">Apply</button>
							</div>
							<div class="col-sm-1">
								<br>
					...
					<div class="modal-content">
						...
						<ul class="nav nav-tabs left-aligned">
							...
							<li class="active" id="filterClass"><a
								onclick="ItemWiseSummary.changeToFilter();">Filter</a></li>
							<li class="" id="sortClass"><a
								onclick="ItemWiseSummary.changeToSort();">Sort</a></li>
						</ul>
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-info"
								onclick="ItemWiseSummary.filterByCategoryAndGroup(); $('#ofModalSearch').modal('hide');">Apply</button>
						</div>
					</div>
				</div>
			</div>
	...
	<spring:url value="/resources/app/item-wise-summary.js"
		var="itemWiseSummaryJs"></spring:url>
	<script type="text/javascript" src="${itemWiseSummaryJs}"></script>
