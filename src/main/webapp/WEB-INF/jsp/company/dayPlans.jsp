...
<title>SalesNrich | Day Plans</title>
...
<body class="page-body" data-url="">
		...
		<div class="main-content">
						...
						<div class="form-group">
							...
							<div class="col-sm-1">
								<button type="button" class="btn btn-info"
									onclick="DayPlan.filter()">Apply</button>
							</div>
						</div>
					</form>
				</div>
			...
			<table class="table  table-striped table-bordered">
				...
				<tbody id="tBodyDayPlans">
					<tr>
						<td colspan='3' align='center'>Please select user and date</td>
					</tr>
				</tbody>
			</table>
			<hr />
	...
	<spring:url value="/resources/app/day-plan.js" var="dayPlanJS"></spring:url>
	<script type="text/javascript" src="${dayPlanJS}"></script>
