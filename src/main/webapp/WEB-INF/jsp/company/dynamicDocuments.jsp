					...
					<form role="form" class="form-horizontal form-groups-bordered">
						<div class="form-group">
							...
							<label class="control-label" for="dbEmployee">Employee</label>
								<select id="dbEmployee" name="employeePid" class="form-control" onchange="DynamicDocument.onChangeUser()">
							...
							<div class="col-sm-2">
								<label class="control-label" for="dbDocument">Document</label>
							...
							<div class="col-sm-2">
								<label class="control-label" for="dbDateSearch">Date</label>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="viewModalLabel">Edit Document Details</h4>
					</div>
					<div class="modal-body">
						<table class="table  table-striped table-bordered">
							<tr>
