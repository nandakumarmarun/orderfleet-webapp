...
<title>SalesNrich | Activity Performance</title>
...
<body class="page-body" data-url="">
				...
				<div class="col-md-12 col-sm-12 clearfix">
					<form role="form" class="form-horizontal form-groups-bordered">
						<div class="form-group">
							...
							<div class="col-sm-3">
								<select id="dbActivityType" name="activityTypePid"
									class="form-control">
									<option value="no">Select Activity Type</option>
									<c:forEach items="${activityTypes}" var="activityType">
										<option value="${activityType.pid}">${activityType.name}</option>
									</c:forEach>
								</select>
							</div>
							<div class="col-sm-2 ">
					...
					<thead>
						<tr>
							...
							<th rowspan="2"
								...
								<th rowspan="2"
								style="text-align: center; color: white; background-color: rgb(48, 54, 65); font-weight: bold; vertical-align: middle;">ACHIEVED TOTAL</th>
							<th rowspan="2"
	...
	<spring:url value="/resources/app/activity-performance-report.js"
		var="activityPerformanceReportJs"></spring:url>
	<script type="text/javascript" src="${activityPerformanceReportJs}"></script>
