...
<title>SalesNrich | Price Level Account Ecom Product Group</title>
</head>
<body class="page-body" data-url="">
	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<hr />
			<h2>Price Level Account Ecom Product Group</h2>
			<div class="row col-xs-12">
				...
				<div class="pull-right">
					<button type="button" class="btn btn-success"
						onclick="PriceLevelAccountEcomProductGroup.showModalPopup($('#ofModalSearch'));">Assign
			...
			<table class="table  table-striped table-bordered">
				...
				<tbody id="tbodyPriceLevelAccountProductGroups">
					<c:forEach items="${priceLevelAccountEcomProductGroups}"
						...
						<tr class="${loopStatus.index % 2 == 0 ? 'odd' : 'even'}">
							...
							<td>
								<button type="button" class="btn btn-blue"
									onclick="PriceLevelAccountEcomProductGroup.showModalPopup($('#viewModal'),'${priceLevelAccountProductGroup.pid}',0);">View</button>
								<button type="button" class="btn btn-blue"
									onclick="PriceLevelAccountEcomProductGroup.showModalPopup($('#myModal'),'${priceLevelAccountProductGroup.pid}',1);">Edit</button>
								<button type="button" class="btn btn-danger"
									onclick="PriceLevelAccountEcomProductGroup.showModalPopup($('#deleteModal'),'${priceLevelAccountProductGroup.pid}',2);">Delete</button>
							</td>
						</tr>
					</c:forEach>
				</tbody>
			...
			<spring:url value="/web/price-level-account-ecom-product-group"
				var="urlPriceLevelAccountEcomProductGroup"></spring:url>
					...
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">
								Search for: <b>PriceLevel Account Ecom ProductGroup</b>
							</h4>
						</div>
						<div class="modal-body">
							<div class="form-group">
								<label class="control-label" for="field_price_Level">Price
									...
									class="form-control" onchange="PriceLevelAccountEcomProductGroup.loadProductGroup();">
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-info"
								onclick="PriceLevelAccountEcomProductGroup.saveAccountAndProductGroup(); $('#ofModalSearch').modal('hide');">Save</button>
						</div>
					</div>
				</div>
			</div>
			<form id="priceLevelAccountEcomProductGroupForm" role="form"
				method="post" action="${urlPriceLevelAccountEcomProductGroup}">
				<!-- Model Container-->
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="viewModalLabel">PriceLevelAccountEcomProductGroup</h4>
							</div>
							<div class="modal-body">
								<div class="modal-body" style="overflow: auto;">
									<!-- error message -->
			...
			<form id="deleteForm" name="deleteForm"
				action="${urlPriceLevelAccountEcomProductGroup}">
				<!-- Model Container-->
							...
							<div class="modal-body">
								...
								<div class="modal-body" style="overflow: auto;">
									...
									<p>Are you sure you want to delete this
										PriceLevelAccountEcomProductGroup?</p>
								</div>
							</div>
							<div class="modal-footer">
								<div class="modal-footer">
	...
	<spring:url value="/resources/app/price-level-account-ecom-product-group.js"
		var="priceLevelAccountEcomProductGroupJs"></spring:url>
	<script type="text/javascript" src="${priceLevelAccountEcomProductGroupJs}"></script>
</body>
</html>