...
<title>SalesNrich | Sales Target Vs Achieved Report(Account Wise)</title>
...
<body class="page-body" data-url="">
	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<hr />
			<h2>Sales Target Vs Achieved Report(Account Wise)</h2>
			...
			<div style="overflow: auto; min-height: 300px;">
				<table style="display: none;"
					...
					id="tblSalesTargetAchievedReportAccountWise">
					<thead>
						<tr>
							<th rowspan="2"
	...
	<spring:url value="/resources/app/sales-target-achieved-report-account-wise.js"
		var="salesTargetAchievedReportAccountWiseJs"></spring:url>
	<script type="text/javascript" src="${salesTargetAchievedReportAccountWiseJs}"></script>
