...
<body class="page-body" data-url="">
	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<hr />
			<h2>Location Wise Sales Comparison Report</h2>
	...
	<spring:url value="/resources/app/location-wise-sales-comparison-report.js"
		var="locationWiseSalesComparisonReportJs"></spring:url>
	<script type="text/javascript" src="${locationWiseSalesComparisonReportJs}"></script>
