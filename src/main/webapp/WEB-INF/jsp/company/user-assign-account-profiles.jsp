...
<body class="page-body" data-url="">
	<div class="page-container">
		...
		<div class="main-content">
				...
				<div class="col-md-3">
					<select id="field_user" name="userPid" class="form-control"><option
						...
						<c:forEach items="${users}" var="user">
							<option value="${user.userPid}">${user.name}</option>
						</c:forEach>
					</select>
				</div>
				<div class="col-sm-1">
			...
			<div class="table-responsive">
				<table id="tblUserAssignAccountProfile" class="table  table-striped table-bordered">
					<thead>
						<tr>
							<th>Name</th>
							<th>Type</th>
	...
	<spring:url value="/resources/app/user-assign-account-profile.js"
		var="userAccountProfileJs"></spring:url>
	<script type="text/javascript" src="${userAccountProfileJs}"></script>
</body>
</html>