						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<br /> <select class="form-control" id="dbDateSearch"
									onchange="InvoiceWiseDuplicateReports.showDatePicker()">
							...
							<div class="input-group col-sm-2">
								<div class="col-sm-3">
									...
									<button type="button" class="btn btn-info entypo-search"
										style="font-size: 18px" onclick="InvoiceWiseDuplicateReports.filter()"
										title="Apply"></button>
								</div>
								<!-- <div class="col-sm-3">
									<br />
...
<%-- 	<script type="text/javascript" src="${tableExport}"></script> --%>
	...
	<spring:url value="/resources/app/invoice-wise-duplicate-report.js"
		var="invoiceWiseDuplicateReportsJs"></spring:url>
	<script type="text/javascript" src="${invoiceWiseDuplicateReportsJs}"></script>
				...
				.ready(
						function() {
							...
							$('#myFormSubmit').on('click', function() {
								InvoiceWiseDuplicateReports.reject();
							});
							$('#btnSaveNewGeoLocation').on('click', function() {
								InvoiceWiseDuplicateReports.saveNewGeoLocation();
							});

							$('#btnSearch').click(
									function() {
										InvoiceWiseDuplicateReports.searchTable($(
												"#search").val(),
												$('#tbodyAccountProfile'));
									});

							$('#newAccountProfile').click(function() {
								InvoiceWiseDuplicateReports.newAccount();
							});

							$('#changeAccount').click(function() {
								InvoiceWiseDuplicateReports.changeAccount();
							});
							$('#return').click(function() {
								InvoiceWiseDuplicateReports.oldAccount();
							});
							...
							$('#createAndChangeAccount').click(function() {
								InvoiceWiseDuplicateReports.createAndChangeAccount();
							});

							$('#loadAccountProfile').click(function() {
								InvoiceWiseDuplicateReports.loadAccountFromForm();
							});
							...
							$('#btnDownload')
									.on(
											...
											function() {
												...
												InvoiceWiseDuplicateReports.downloadXls();
											});
							$('#btnTestdownload')
							.on(
									'click',
									function() {
										...
										InvoiceWiseDuplicateReports.testdownloadXls();
									});
