...
<html lang="en">
<head>
<title>SalesNrich | LiveRouting</title>
...
<spring:url value="/resources/app/live-routing.js" var="liveRouting"></spring:url>
<script type="text/javascript" src="${liveRouting}"></script>
