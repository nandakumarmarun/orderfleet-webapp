...
<title>SalesNrich | Attendance Report</title>
...
<body class="page-body" data-url="">
	...
	<div class="page-container">
		...
		<div class="main-content">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select class="form-control" id="dbDateSearch"
									onchange="AttendanceReport.showDatePicker()">
							...
							<div class="col-sm-1">
								<button type="button" class="btn btn-info"
									onclick="AttendanceReport.filter()">Apply</button>
							</div>
							<div class="col-sm-1">
			...
			<%-- 	<div class="row-fluid">
				<util:pagination thispage="${pageAttendanceReport}"></util:pagination>
			</div> --%>
			<hr />
			<!-- Footer -->
	...
	<spring:url value="/resources/app/attendance-report.js"
		var="attendanceReportJs"></spring:url>
	<script type="text/javascript" src="${attendanceReportJs}"></script>
</body>
</html>