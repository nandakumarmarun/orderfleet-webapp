						...
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<div class="modal-body" style="overflow: auto; height: 500px;">
									...
									<div id="divLoadFromMobileData">
										<div class="form-group">
											<label class="control-label">Load From Mobile</label> <input
												id="loadFromMobile" name='loadFromMobile' type='checkbox'
												class="form-control" />
										</div>
									</div>
									<div id="divLoadMobileData">
										<div class="form-group">
											<label class="control-label" for="field_type">Load
												Mobile Data</label> <select id="loadMobileData"
												name="loadMobileData" class="form-control">
												<c:forEach items="${loadMobileDataList}"
													var="loadMobileData">
