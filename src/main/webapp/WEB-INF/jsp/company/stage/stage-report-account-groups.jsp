...
<title>SalesNrich | Stage Report Account Groups</title>
...
<body class="page-body" data-url="">
		...
		<div class="main-content">
			...
			<div class="row">
				<div class="col-md-6 col-sm-6 clearfix">
					<h2 id="title">Stage Report Account Groups</h2>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-sm-3">
					Account Groups <select id="dbAccountGroups" name="accountGroupPid"
						class="form-control" onchange="StageReportAccountGroups.selectAccountGroups()">
						<option value="-1">Select Account Groups</option>
						<c:forEach items="${accountGroups}" var="accountGroup">
							<option value="${accountGroup.pid}">${accountGroup.name}</option>
						</c:forEach>
					</select>
				</div>
				<div class="col-sm-3">
				...
				<div class="col-sm-3">
					Day <select class="form-control" id="dbDateSearch"
						onchange="StageReportAccountGroups.showDatePicker()">
				...
				<div class="col-sm-2">
					...
					<button type="button" class="btn btn-info"
						onclick="StageReportAccountGroups.filter()">Apply</button>
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered"
					id="tblStageReportAccountGroups">
					<thead id="tHeadStageReportAccountGroups">
						<tr>
							<th>Date <i onclick="StageReportAccountGroups.sortTable(0)" class="fa fa-sort float-right" aria-hidden="true"></i></th>
							<th>Contact</th>
							<th>Stage</th>
							<th>User</th>
							<th>Remarks</th>
					...
					<tbody id="tBodyStageReportAccountGroups">
					</tbody>
				</table>
			</div>
				...
				<div class="modal-dialog" style="width: 100%;">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div>
								<spring:url value="/web/stage-report-account-groups" var="urlStageReportAccountGroups"></spring:url>
								<form id="formSaveNewStage" method="post"
									action="${urlStageReportAccountGroups}" enctype="multipart/form-data">
	...
	<spring:url value="/resources/app/lead-to-sales/stage-report-account-groups.js" var="stageReportAccountGroupsJs"></spring:url>
	<script type="text/javascript" src="${stageReportAccountGroupsJs}"></script>
