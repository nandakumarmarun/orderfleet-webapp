...
<body class="page-body" data-url="">
	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<div class="row col-xs-12">
				<div class="pull-right">
					<button type="button" class="btn btn-success"
						onclick="Bank.showModalPopup($('#myModal'));">Create new
						Bank</button>
				</div>
			</div>
			<br> <br>
			<div class="row col-xs-12">
				<div class="pull-right">
					<button type="button" class="btn"
						onclick="Bank.showModalPopup($('#enableBankModal'));">Deactivated
						Bank</button>
				</div>
			</div>
				...
				<tbody>
					<c:forEach items="${banks}" var="bank"
						...
						<tr class="${loopStatus.index % 2 == 0 ? 'odd' : 'even'}">
							...
							<td>${bank.description == null ? "" : bank.description}</td>
							<td><span class="label ${bank.activated? 'label-success':'label-danger' }"
							onclick="Bank.setActive('${bank.name}','${bank.pid}','${ !bank.activated}')"
							style="cursor:pointer;">${bank.activated? "Activated" : "Deactivated"}</span></td>
							<td>
								<button type="button" class="btn btn-blue"
									onclick="Bank.showModalPopup($('#viewModal'),'${bank.pid}',0);">View</button>
								<button type="button" class="btn btn-blue"
									onclick="Bank.showModalPopup($('#myModal'),'${bank.pid}',1);">Edit</button>
								<button type="button" class="btn btn-danger"
									onclick="Bank.showModalPopup($('#deleteModal'),'${bank.pid}',2);">Delete</button>
							</td>
						</tr>
					</c:forEach>
				</tbody>
			...
			<form id="bankForm" role="form" method="post" action="${urlBank}">
				<!-- Model Container-->
					...
					<div class="modal-content">
								...
								<div id="accountsCheckboxes">
									<table class='table table-striped table-bordered'>
										...
										<tbody id="tblEnableBank">
											<c:forEach items="${deactivatedBanks}"
												var="bank">
												<tr>
						...
						<div class="modal-footer">
							<input class="btn btn-success" type="button"
								id="btnActivateBank" value="Activate" />
	...
	<spring:url value="/resources/app/bank.js" var="bankJs"></spring:url>
	<script type="text/javascript" src="${bankJs}"></script>
</body>
</html>