...
<title>SalesNrich | Locations Hierarchy</title>
</head>
					...
					<div class="modal-content">
						...
						<div class="modal-footer">
							<div class="modal-footer">
								...
								<button onclick="this.disabled=true;saveRootLocation();" class="btn btn-primary">Save</button>
							</div>
						</div>
					</div>
					<!-- /.modal-content -->
	...
	<script type="text/javascript">
		...
		function saveRootLocation() {
			$.ajax({
				...
				contentType : "application/json; charset=utf-8",
				data : JSON.stringify($('#dropdownLocation option:selected').val()),
				success : function(data) {
					//reloading page to see the updated data
					window.location = location.protocol + '//' + location.host + '/web/location-hierarchy';
				},
				error : function(xhr, error) {
					onError(xhr, error);
				}
