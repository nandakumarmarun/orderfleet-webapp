...
<title>SalesNrich | Location Wise Product Group 
	Report</title>
...
<body class="page-body" data-url="">
	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<hr />
			<h2>Location Wise Product Group Report</h2>
			...
			<div class="row">
				...
				<div class="col-md-12 col-sm-12 clearfix">
					<form role="form" class="form-horizontal form-groups-bordered">
						<div class="form-group">
							<div class="col-sm-3">
								<label>Product Groups</label> <select id="dbProduct"
									name="productPid" class="form-control">
        		...
        		<div class="col-xs-2"><button id="applyBtn" type="button" class="btn btn-info">Apply</button>
							</div>
						</div>
					</form>
				</div>
	...
	<spring:url
		value="/resources/app/location-wise-product-group-report.js"
		var="locationWiseProductGroupReportJs"></spring:url>
	<script type="text/javascript"
		src="${locationWiseProductGroupReportJs}"></script>
