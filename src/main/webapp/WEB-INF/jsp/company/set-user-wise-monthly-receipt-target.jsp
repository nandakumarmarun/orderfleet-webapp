...
<title>SalesNrich | Set Monthly User Wise Receipt Target</title>
...
<body class="page-body" data-url="">
	<div class="page-container">
		...
		<div class="main-content">
			...
			<hr />
			<h2>Set Monthly User Wise Receipt Target</h2>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<input type="hidden" id="hdnUserPid" /> <input type="hidden"
								id="hdnUserWiseReceiptTargetPid" />
							<div class="form-group">
						...
						<div class="modal-footer">
							<input class="btn btn-success" type="button" id="saveTarget"
								value="Save"
								onclick="SetMonthlyUserWiseReceiptTarget.saveTarget()" />
	...
	<spring:url
		value="/resources/app/set-user-wise-monthly-receipt-target.js"
		var="setUserWiseMonthlyReceiptTargetJs"></spring:url>
	<script type="text/javascript"
		src="${setUserWiseMonthlyReceiptTargetJs}"></script>
