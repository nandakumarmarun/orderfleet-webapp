...
<title>SalesNrich | Set Monthly User Wise Sales Target</title>
...
<body class="page-body" data-url="">
	<div class="page-container">
		...
		<div class="main-content">
			...
			<hr />
			<h2>Set Monthly User Wise Sales Target</h2>
				...
				<div class="col-md-12 col-sm-12 clearfix">
					<form role="form" class="form-horizontal form-groups-bordered">
						<div class="form-group">
							...
							<div class="col-sm-2">
								<button id="btnApplyMonthlyUsers" type="button"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<input type="hidden" id="hdnUserPid" /> <input type="hidden" id="hdnUserWiseSalesTargetPid" />
							<div class="form-group">
						...
						<div class="modal-footer">
							<input class="btn btn-success" type="button" id="saveTarget"
								value="Save"
								onclick="SetMonthlyUserWiseSalesTarget.saveTarget()" />
	...
	<spring:url
		value="/resources/app/set-user-wise-monthly-sales-target.js"
		var="setUserWiseMonthlySalesTargetJs"></spring:url>
	<script type="text/javascript" src="${setUserWiseMonthlySalesTargetJs}"></script>
