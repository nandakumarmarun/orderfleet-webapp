...
<title>SalesNrich | User Ecom Product Groups</title>
<style type="text/css">
.error {
	color: red;
}
...
<body class="page-body" data-url="">
						...
						<tr class="${loopStatus.index % 2 == 0 ? 'odd' : 'even'}">
							...
							<td>
								<button type="button" class="btn btn-info"
									onclick="UserEcomProductGroup.showModalPopup($('#productGroupsModal'),'${user.pid}',0);">Assign
									Ecom Product Groups</button>
							</td>
						</tr>
					</c:forEach>
				</tbody>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">Assign Product Groups</h4>
						</div>
	...
	<spring:url value="/resources/app/user-ecom-product-group.js"
		var="userEcomProductGroup"></spring:url>
	<script type="text/javascript" src="${userEcomProductGroup}"></script>
