...
<html lang="en">
  <head>
    ...
    <spring:url
      value="/resources/assets/css/flipclock.css"
      var="flipclockCss"
    ></spring:url>
  ...
  <spring:url
    value="/resources/assets/css/dashboard-custom.css"
    var="dashboardCss"
  ></spring:url>
  <link href="${dashboardCss}" rel="stylesheet" />

  <spring:url
    value="/resources/assets/css/dashborad-denormalised.css"
    var="dashboarddenormalisedCss"
  ></spring:url>
  <link href="${dashboarddenormalisedCss}" rel="stylesheet" />
  ...
  <spring:url
    value="/resources/assets/plugin/britecharts/css/bar.min.css"
    var="barMinCss"
  ></spring:url>
  ...
  <body class="page-body" data-url="">
    <div class="page-container">
      ...
      <div class="main-content">
        ...
        <hr />
        <div>
          <div class="row fillter-row">
            <div>
            <div class="col-sm-3">
              <div class ="fillter-card">
          ...
          <div class="row" style="color: white">
            <div class="col-sm-6 col-md-3 col-lg-3 col-xs-12">
              <div class ="chart-label-new">
                ...
                <div id="chartContainer">
                    <img rc="/resources/assets/images/menu-ajax-loader.gif"
            ...
            <div class="col-sm-6 col-md-3 col-lg-3 col-xs-12">
              <div class="tile-card tile-blue" style="height: auto">
                <div class="tile-card-header font-size-14">
                  <i class="entypo-chart-line"></i>
                  <a
                    href="/web/executive-task-executions?filterBy=TODAY"
                    class="text-center"
                  >
                    <label id="lblDate" style="cursor: pointer"
                      ></label
                    ></a
                  >
                </div>
                <div id="divDaySummary">
                  <img
                    src="/resources/assets/images/menu-ajax-loader.gif"
                    style="display: block; margin: auto"
                  />
                </div>
              </div>
            ...
            <div class="col-sm-6 col-md-3 col-lg-3 col-xs-12">
              <div class="tile-card tile-magentha">
                <div class="tile-card-header font-size-14">
                  <i class="entypo-chart-line"></i>
                  <a
                    ...
                    class="text-center"
                  >
                    <label id="fromDateWeek" style="cursor: pointer"></label> To
                    <label id="toDateWeek" style="cursor: pointer"></label
                  ></a>
                </div>
            ...
            <div class="col-sm-6 col-md-3 col-lg-3 col-xs-12">
              <div class="tile-card tile-orenge">
                <div class="tile-card-header font-size-14">
                  <i class="entypo-chart-line"></i>
                  <a
                    ...
                    class="text-center"
                  >
                    <label id="fromDateMonth" style="cursor: pointer"></label>
                    To <label id="toDateMonth" style="cursor: pointer"></label
                  ></a>
                </div>
          ...
          <div id="divAttendancePanel" class="attendence-panel">
            <div class="row">
                ...
                <div class="panel panel-primary" data-collapsed="0">
                  ...
                  >
                    <div class="panel-title">
                      <strong
                        >Live streaming - Salesman wise performance</strong
                      >
                      &nbsp;&nbsp;|&nbsp;&nbsp;
                      <strong
                        ><b
                    ...
                    <div class="panel-options" style="padding: 10px 15px">
                      <button
                        ...
                        class="btn btn-blue btn-xs tooltip-info"
                      >
                        Set Delay Time
                      </button>
                      <a href="#" data-rel="collapse"
                        ><i class="entypo-down-open" style="color: white"></i
                      ></a>
                    </div>
                  </div>
                </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group">
                <label>Set delay time in minute</label>
                <input
                  type="text"
                  id="txtDelayTime"
                  class="form-control"
    ...
    <spring:url
      value="/resources/assets/js/websocket/sockjs-0.3.4.js"
      var="StockJs"
    ></spring:url>
    <script type="text/javascript" src="${StockJs}"></script>

    <spring:url
      value="/resources/assets/js/websocket/stomp.js"
      var="StompJs"
    ></spring:url>
    <script type="text/javascript" src="${StompJs}"></script>

    <spring:url
      value="/resources/assets/plugin/d3/d3.min.js"
      var="d3Js"
    ></spring:url>
    <script type="text/javascript" src="${d3Js}"></script>
    <spring:url
      value="/resources/assets/plugin/britecharts/js/bar.min.js"
      var="barMinJs"
    ></spring:url>
    ...
    <spring:url
      value="/resources/assets/plugin/d3/d3-funnel.min.js"
      var="d3FunnelJs"
    ></spring:url>
    ...
    <!-- custom -->
    <spring:url
      value="/resources/app/dashboard-new.js"
      var="dashboardJs"
    ></spring:url>
    ...
    <spring:url
      value="/resources/assets/js/flipclock.min.js"
      var="flipclockJs"
    ></spring:url>
    ...
    <script type="text/javascript">
      $(document).ready(function () {
        if (
          window.matchMedia("(max-width: 990px) and (min-width: 768px)").matches
        ) {
          $(".sidebar-collapse-icon").click(function () {
            $(".tile-content .table_ .head").css("width", "100%");
            $(".tile-content .table_ .body").css("width", "100%");
          });
        }
      });
    </script>
