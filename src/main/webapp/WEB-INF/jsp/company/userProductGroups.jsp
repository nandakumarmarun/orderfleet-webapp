...
<title>SalesNrich | User Product Groups</title>
<style type="text/css">
.error {
	color: red;
}
...
<body class="page-body" data-url="">
						...
						<tr class="${loopStatus.index % 2 == 0 ? 'odd' : 'even'}">
							...
							<td>
								<button type="button" class="btn btn-info"
									onclick="UserProductGroup.showModalPopup($('#productGroupsModal'),'${user.pid}',0);">Assign
	...
	<spring:url value="/resources/app/user-product-group.js"
		var="userProductGroup"></spring:url>
	<script type="text/javascript" src="${userProductGroup}"></script>
