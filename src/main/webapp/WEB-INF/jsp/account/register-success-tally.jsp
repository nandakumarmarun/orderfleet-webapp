			...
			<div class="col-sm-12">
				...
				<ul class="list-group">
					<li class="list-group-item borderless">
						<p>1. Download Integration Tally TDL from <a href="/downloadTally/">here</a></p>
					</li>
					<li class="list-group-item borderless">
						<p>2. Load Integration Tally TDL to Tally ERP</p>
					</li>
					<li class="list-group-item borderless">
						<p>3. Check your inbox for registration key , Use it to configure Tally ERP </p>
					</li>
					<li class="list-group-item borderless">
						<p>4. Goto <a href="https://play.google.com/store/apps/details?id=com.aitrich.android.orderpro&hl=en" target="_blank">here</a> and install mobile app.</p>
					</li>
				</ul>
