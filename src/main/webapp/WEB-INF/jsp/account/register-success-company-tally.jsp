...
<style type="text/css">
 ...
 <body>
	...
	<div class="col-lg-6 fah">
		<div class="row">
			<div class="col-sm-12">
				<h1>Company and Tally configured Successfully !</h1>
				<ul class="list-group">
					<li class="list-group-item borderless">
						<p> Goto <a href="https://play.google.com/store/apps/details?id=com.aitrich.android.orderpro&hl=en" target="_blank">here</a> and install mobile app.</p>
					</li>
				</ul>
