...
<title>SalesNrich | Client App Log Files</title>
</head>
<style type="text/css">
.error {
	color: red;
...
<body class="page-body" data-url="">
							...
							<div class="input-group col-sm-2">
								<div class="col-sm-3">
									...
									<button type="button" class="btn btn-info entypo-search"
										...
										onclick="ClientAppLogFilesReport.filter()" title="Apply"></button>
								</div>
							</div>
						</div>
					</form>
	...
	<spring:url value="/resources/app/clientappLogFile.js"
		var="clientAppLogFilesJs"></spring:url>
	<script type="text/javascript" src="${clientAppLogFilesJs}"></script>
</body>
</html>