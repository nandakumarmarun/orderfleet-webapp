...
<body class="page-body" data-url="">
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="modal-body">
						...
						<div class="form-group">
							<label class="control-label">Document</label> <select
								onchange="StaticJsCode.onChangeDocument();" id="dbDocument"
	...
	<spring:url value="/resources/app/static-js-code.js" var="staticJsCode"></spring:url>
