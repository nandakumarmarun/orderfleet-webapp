...
<title>SalesNrich |Company User Build Version</title>
<style type="text/css">
.error {
	color: red;
}
...
<body class="page-body" data-url="">
	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<hr />
			<h2>Company User Build Version</h2>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<button type="button" class="btn btn-orange" style="width: 65px;"
							onclick="CompanyUserDevice.getCompanyUserDevice()">Load</button>
					</div>
				</div>
				<div class="col-sm-3">
			...
			<table class="table  table-striped table-bordered">
				...
				<tbody id="tableCompanyUserDevice">
				</tbody>
			</table>
			<hr />
			<!-- Footer -->
	...
	<spring:url value="/resources/app/company-user-build-vaersions.js"
		var="companyUserBuildVersionJs"></spring:url>
	<script type="text/javascript" src="${companyUserBuildVersionJs}"></script>
</body>
</html>