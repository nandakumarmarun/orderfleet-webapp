...
<!--<![endif]-->
<head>
<title>Van Sales | SalesNrich</title>
	...
	<div class="wrapper">
		...
		<div class="breadcrumbs-v3 img-v3 text-center margin-bottom-60">
			<div class="container">
				...
				<h1>for Van sales Management</h1>
		...
		<div class="container margin-bottom-40">
			<div class="row">
				<div class="col-md-6">
					<h2 class="title-v2">Van Sales</h2>
					<!--<p>Say good bye to the time consuming manual data consolidation and move on to a simple zero error -prone approach with SalesNrich Van sales. Van sales allows you real time visibility into Van Stock at any given time. Van sales lets you embrace hassle free stock and sales order settlement with up-to-date synchronization with the back office.</p>
                
                 <p>Enhance your productivity with preplanned journey routes with GPS tracking. optimize your sales staff thereby increasing  your market reach. It is possible to completely integrate  SalesNrich Van sales  with your existing accounting system.</p><br>-->
					<p>Say good bye to the time consuming manual data consolidation
						and move on to a simple zero error -prone approach with SalesNrich
						VanSales. VanSales allows you real time visibility into billing &
						van stock at any given time. VanSales lets you embrace hassle free
						stock and sales order settlement with up-to-date synchronization
						with the back office. Enhance your productivity with pre-planned
						journey routes with GPS tracking. It allows seamless integration
						with your existing ERP/Billing system.</p>
				...
				<div class="row margin-bottom-40">
					<div class="col-md-4">
						<div class="content-boxes-v5 margin-bottom-30">
							...
							<div class="overflow-h">
								<h3 class="no-top-space">Route planning / Scheduling</h3>
								<p>Excellent route planning feature with manager approval
									(optional) in case of sales person’s plan deviation, with
									supporting schedule adherence reports.</p>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="content-boxes-v5 md-margin-bottom-30">
							...
							<div class="overflow-h">
								<h3 class="no-top-space">Sales Return</h3>
								<p>The system supports sales return management for both
									damaged as well sellable items.</p>
								<br>
								<br>
							</div>
						</div>
					...
					<div class="col-md-4">
						<div class="content-boxes-v5 margin-bottom-30">
							...
							<div class="overflow-h">
								<h3 class="no-top-space">Receivables & Outstanding</h3>
								<p>Receipts entries are supported with bills wise allocation
									facility .</p>
								<br>
								<br>
								<br>
					...
					<div class="col-md-4">
						<div class="content-boxes-v5 md-margin-bottom-30">
							...
							<div class="overflow-h">
								<h3 class="no-top-space">Territory Management</h3>
								<p>SalesNrich supports grouping accounts and managing access
									to those groups by the respective members, and provides
									different territory wise sales reports and charts.</p>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="content-boxes-v5 margin-bottom-30">
							...
							<div class="overflow-h">
								<h3 class="no-top-space">ERP Integration</h3>
								<p>Works in synch with partner system in managing stock
									location wise inventory, stock transfers, invoices, receipts,
									etc.</p>
								<br>
							</div>
						</div>
		...
		<div class="bg-color-dark-blue">
			<div class="container content-sm no-bottom-space">
				...
				<div class="title-box margin-bottom-40">
					<div class="title-box-text">Make a request for VanSales Demo</div>
				</div>
				...
				<div class="row text-center">
					...
					<div class="col-md-4 flat-service">
						...
						<span
							...
							style="font-size: 50px;"></span>
						<h1 class="title-v1-md margin-bottom-10">Seek support</h1>
					...
					<div class="row">
						...
						<div class="col-md-3 md-margin-bottom-40">
							...
							<p>Say good bye to the time consuming manual data
								...
								with SalesNrich VanSales.</p>
							<p>VanSales allows you real time visibility into billing &
								van stock at any given time...</p>
						</div>
						<!--/col-md-3-->
						<!-- End About -->
						<!-- Latest -->
