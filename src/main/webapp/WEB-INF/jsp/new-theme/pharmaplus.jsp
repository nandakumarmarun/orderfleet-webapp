...
<!--<![endif]-->
<head>
<title>Pharma Plus | SalesNrich</title>
...
<body>
	<div class="wrapper">
		...
		<div class="container margin-bottom-40">
			<div class="row">
				<div class="col-md-6">
					<h2 class="title-v2">Pharma Plus</h2>
                 ...
                 <p>Approach individual customers with the complete know-how on previous encounters. Having a SaleNrich will allow you to intentionally pursue new business systematically for target accounts. Whichever domain you may be market pro is your solution to exponential productivity with minimum effort. Make bespoke strategies that would engrave your firm in the market share.</p><br>-->
					<p>
						<strong>SalesNrich PharmaPlus</strong> is specially designed to
						enrich sales & marketing related activities of your pharmaceutical
						business. It helps you manage daily Call Reports (DCR), Doctors
						appointments and visits, Primary as well as Secondary Sales
						Orders, Expense Entries, and Samples or Gifts issues. It helps to
						identify doctors with respective products and supports well
						targeted marketing approaches. PharmaPlus supports medical reps in
						identifying and applying efforts in right direction with the helps
						different analysis and reports.
					</p>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-3 md-margin-bottom-40">
							...
							<p>SalesNrich PharmaPlus is specially designed to enrich
								sales & marketing related activities of your pharmaceutical
								business.</p>
							<p>It helps you manage daily Call Reports (DCR), Doctors
								appointments and visits, Primary as well as Secondary Sales
								Orders...</p>
						</div>
						<!--/col-md-3-->
