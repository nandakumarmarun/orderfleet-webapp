...
<!--<![endif]-->
<head>
<title>Market Pro | SalesNrich</title>
...
<body>
	<div class="wrapper">
		...
		<div class="container margin-bottom-40">
			<div class="row">
				<div class="col-md-6">
					<h2 class="title-v2">Market Pro</h2>
                 ...
                 <p>Approach individual customers with the complete know-how on previous encounters. Having a SaleNrich will allow you to intentionally pursue new business systematically for target accounts. Whichever domain you may be market pro is your solution to exponential productivity with minimum effort. Make bespoke strategies that would engrave your firm in the market share.</p><br>-->
					<p>
						<strong>SalesNrich MarketPro</strong> helps to scale your business
						with monitored marketing activities. Hasten your sales and
						marketing activities in an effective and efficient manner. See the
						span growth of your firm in your target market - live and on a
						daily basis. Avoid the human errors by auto guiding the activities
						of your representatives on the go. Helps you approach individual
						customers with the complete know-how on previous encounters.
						Whatever may your domain be - MarketPro is your solution to
						exponential productivity with minimum effort.
					</p>
				...
				<div class="row margin-bottom-40">
					<div class="col-md-4">
						<div class="content-boxes-v5 margin-bottom-30">
							...
							<div class="overflow-h">
								<h3 class="no-top-space">Visit Plans & Management</h3>
								<p>Field activities such as visiting leads, prospects, and
									existing customers can be planned well as schedules, and
									execution related reporting can be managed well using
									SalesNrich.</p>
							</div>
						</div>
					...
					<div class="col-md-4">
						<div class="content-boxes-v5 margin-bottom-30">
							...
							<div class="overflow-h">
								<h3 class="no-top-space">Survey Management</h3>
								<p>SalesNrich helps to manage different types of surveys
									related to sales & marketing.</p>
							</div>
						</div>
						<div class="content-boxes-v5 md-margin-bottom-30">
							<i class="rounded-x icon-user "></i>
							<div class="overflow-h">
								<h3 class="no-top-space">Lead to Cash</h3>
								<p>SalesNrich supports business process automation related
									to sales & marketing.</p>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="content-boxes-v5 margin-bottom-30">
							...
							<div class="overflow-h">
								<h3 class="no-top-space">Field Activity Management</h3>
								<p>Various filed activities such as Customer visits,
									Sales/Channel Partner visits, Surveys, Custom Activities,
									Competitor Analysis, Exhibitions/stalls activity, etc. can be
									well managed and monitored using SalesNrich.</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-3 md-margin-bottom-40">
							...
							<p>SalesNrich MarketPro helps to scale your business with
								...
								activities in an effective and efficient manner.</p>
							<p>See the span growth of your firm in your target market -
								live and on a daily basis. Avoid the human errors by auto...</p>
						</div>
						<!--/col-md-3-->
						<!-- End About -->
						<!-- Latest -->
						...
						<div class="col-md-3 md-margin-bottom-40">
							...
							<ul class="list-unstyled link-list">
								...
								<li><a href="contacts">Contact us</a><i
