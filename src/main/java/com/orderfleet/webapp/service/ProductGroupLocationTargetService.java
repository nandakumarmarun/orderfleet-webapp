...
public interface ProductGroupLocationTargetService {
	 ...
	 */
	/*
	 * SalesTargetGroupUserTargetDTO save(SalesTargetGroupUserTargetDTO
	 ...
	 *//**
		 ...
		 */
	/*
	 * SalesTargetGroupUserTargetDTO update(SalesTargetGroupUserTargetDTO
	 * salesTargetGroupUserTargetDTO);
	 * 
	 *//**
	 ...
	 *//**
		 ...
		 *//*
			 ...
			 * 
			 * List<SalesTargetGroupUserTarget>
			 ...
			 * 
			 * SalesTargetGroupUserTargetDTO saveMonthlyTarget(SalesMonthlyTargetDTO
			 * monthlyTargetDTO, LocalDate firstDateMonth, LocalDate lastDateMonth);
			 * 
			 * SalesTargetGroupUserTargetDTO saveUpdateDaylyTarget(
			 * List<SalesTargetGroupUserTargetDTO> salesTargetGroupUserTargetDTOs);
			 * 
			 * List<SalesTargetGroupUserTargetDTO>
