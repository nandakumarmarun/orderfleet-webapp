...
//					}
	...
	@Transactional
	public void saveUpdateLocationHierarchyUpdateIdNew(final List<LocationHierarchyDTO> locationHierarchyDTOs,
			final SyncOperation syncOperation) {
		long start = System.nanoTime();
...
//		});
	...
	@Transactional
	@Async
	public void saveUpdateReceivablePayablesUpdateIdNew(final List<ReceivablePayableDTO> receivablePayableDTOs,
			final SyncOperation syncOperation) {
		long start = System.nanoTime();
		final Company company = syncOperation.getCompany();
		Set<ReceivablePayable> saveReceivablePayable = new HashSet<>();
...
//		accountProfileRepository.save(accountProfilescopy);
	...
	@Transactional
	@Async
	public void saveUpdateAccountProfileClosingBalancesUpdateIdNew(final List<AccountProfileDTO> accountProfileDTOs,
			final SyncOperation syncOperation) {
		long start = System.nanoTime();
		Long companyId = syncOperation.getCompany().getId();
		Set<AccountProfile> saveUpdateAccountProfiles = new HashSet<>();
