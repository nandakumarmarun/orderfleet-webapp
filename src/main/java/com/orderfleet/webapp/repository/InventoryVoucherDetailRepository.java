...
public interface InventoryVoucherDetailRepository extends JpaRepository<InventoryVoucherDetail, Long> {
	...
	@Query(value = "select voucherDetail.inventoryVoucherHeader.employee.name, voucherDetail.product.pid, voucherDetail.product.name, voucherDetail.product.unitQty, voucherDetail.quantity,voucherDetail.inventoryVoucherHeader.receiverAccount.name, voucherDetail.inventoryVoucherHeader.documentDate, voucherDetail.inventoryVoucherHeader.executiveTaskExecution.remarks,voucherDetail.inventoryVoucherHeader.receiverAccount.pid,voucherDetail.rowTotal,voucherDetail.inventoryVoucherHeader.document.name,voucherDetail.volume,voucherDetail.inventoryVoucherHeader.createdDate, voucherDetail.product.productDescription, voucherDetail.product.compoundUnitQty from InventoryVoucherDetail voucherDetail where voucherDetail.inventoryVoucherHeader.receiverAccount.pid in ?1 and voucherDetail.inventoryVoucherHeader.createdBy.id in ?2 and voucherDetail.inventoryVoucherHeader.document.id in ?3 and voucherDetail.inventoryVoucherHeader.documentDate between ?4 and ?5 and voucherDetail.product.activated=true order by voucherDetail.inventoryVoucherHeader.documentDate desc")
