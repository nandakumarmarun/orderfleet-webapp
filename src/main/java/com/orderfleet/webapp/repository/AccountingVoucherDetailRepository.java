...
public interface AccountingVoucherDetailRepository extends JpaRepository<AccountingVoucherDetail, Long> {
	...
	List<AccountingVoucherDetail> findAllByCompanyIdByAccountAndToAccountAndPaymentModeAndAccountingVoucherHeaderPid(String byaccount,String toaccount,PaymentMode paymentMode,String documentPid,String activityPid);
	...
	List<Object[]> findByDocumentIdInAndDateBetweenOrderByCreatedDateDesc(Set<Long> documentId,
			LocalDateTime fromDate, LocalDateTime toDate);
