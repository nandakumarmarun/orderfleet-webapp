 ...
 */
@Entity
@Table(name = "tbl_account_group")
public class AccountGroup implements Serializable, Cloneable {
	...
	public String toString() {
		return "AccountGroup [id=" + id + ", pid=" + pid + ", name=" + name + ", alias=" + alias + ", description="
