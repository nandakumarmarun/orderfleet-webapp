...
@Entity
@Table(name = "tbl_financial_closing_detail_accounting")
public class FinancialClosingDetailAccounting implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GenericGenerator(name = "seq_financial_closing_detail_accounting_id_GEN", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator", parameters = {
			@Parameter(name = "sequence_name", value = "seq_financial_closing_detail_accounting_id") })
	@GeneratedValue(generator = "seq_financial_closing_detail_accounting_id_GEN")
	@Column(name = "id", insertable = false, updatable = false, columnDefinition = "bigint DEFAULT nextval('seq_financial_closing_detail_accounting_id')")
	private Long id;
