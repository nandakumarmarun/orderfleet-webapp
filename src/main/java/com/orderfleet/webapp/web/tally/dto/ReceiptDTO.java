...
public class ReceiptDTO {
	...
	public ReceiptDTO(AccountingVoucherDetail accountingVoucherDetail) {
		...
		for(AccountingVoucherAllocation accountingVoucherAllocation : accountingVoucherDetail.getAccountingVoucherAllocations()){
	...
	/*public ReceiptDTO(AccountingVoucherAllocation accountingVoucherAllocation) {
		...
		this.pid = accountingVoucherAllocation.getAccountingVoucherDetail()
