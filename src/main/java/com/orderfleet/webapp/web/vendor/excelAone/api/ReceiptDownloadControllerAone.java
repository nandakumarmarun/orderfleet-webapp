package com.orderfleet.webapp.web.vendor.excelAone.api;
...
public class ReceiptDownloadControllerAone {

	private final Logger log = LoggerFactory.getLogger(ReceiptDownloadControllerAone.class);
