...
import com.orderfleet.webapp.web.vendor.excelPR.service.ProductProfileUploadPRService;

@RestController
@RequestMapping(value = "/api/excelPR/v1")
public class ProductProfileExcelPR {

	private final Logger log = LoggerFactory.getLogger(ProductProfileExcelPR.class);
	...
	@Inject
	private ProductProfileUploadPRService productProfileUploadService;
