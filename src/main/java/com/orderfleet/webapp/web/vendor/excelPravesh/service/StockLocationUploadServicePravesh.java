 ...
 */
@Service
public class StockLocationUploadServicePravesh {

	private final Logger log = LoggerFactory.getLogger(StockLocationUploadServicePravesh.class);
	...
	public StockLocationUploadServicePravesh(BulkOperationRepositoryCustom bulkOperationRepositoryCustom,
