 ...
 */
@Service
public class EmployeeProfileUploadServicePravesh {

	private final Logger log = LoggerFactory.getLogger(EmployeeProfileUploadServicePravesh.class);
	...
	public EmployeeProfileUploadServicePravesh(SyncOperationRepository syncOperationRepository) {
		super();
