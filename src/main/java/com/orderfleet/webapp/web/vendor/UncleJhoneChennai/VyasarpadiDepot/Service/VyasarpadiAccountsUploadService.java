...
@Service
public class VyasarpadiAccountsUploadService {
	String PID_PREFIX = "DDA-";

	final String FACTORY_CODE ="KV";
	final String FACTORY_NAME = "VYASARPADI DEPOT";



	private final Logger log = LoggerFactory.getLogger(VyasarpadiAccountsUploadService.class);
	...
	public VyasarpadiAccountsUploadService(BulkOperationRepositoryCustom bulkOperationRepositoryCustom,
	...
	public void saveUpdateLocationAccounts(
		...
		Company company = companyRepository.findOne(companyId);
		String Thread = "Thread "+RandomUtil.generateThread()+" -- ["+company.getLegalName()+"] : ";
		log.info(Thread + "Enter : saveUpdateLocationAccounts() ");
	...
	private List<LocationHierarchyDTO> locationToLocationHierarchyDtos(
		...
		Company company = companyRepository.findOne(companyId);
		String Thread = "Thread "+RandomUtil.generateThread()+" -- ["+company.getLegalName()+"] : ";
		log.info(Thread + "Enter : locationToLocationHierarchyDtos() ");
