package com.orderfleet.webapp.web.vendor.ujtirunelveli.service;
...
@Service
public class UjTirunelveliAccountService {

    String PID_PREFIX = "DDA-";

    final String FACTORY_CODE ="TI";

    final String FACTORY_NAME = "TIRUNELVELI DEPOT";
    ...
    public UjTirunelveliAccountService(BulkOperationRepositoryCustom bulkOperationRepositoryCustom,
