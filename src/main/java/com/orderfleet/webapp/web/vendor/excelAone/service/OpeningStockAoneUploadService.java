 ...
 */
@Service
public class OpeningStockAoneUploadService {

	private final Logger log = LoggerFactory.getLogger(OpeningStockAoneUploadService.class);
	...
	public OpeningStockAoneUploadService(BulkOperationRepositoryCustom bulkOperationRepositoryCustom,
