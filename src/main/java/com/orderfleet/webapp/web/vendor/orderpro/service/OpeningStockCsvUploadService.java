 ...
 */
@Service
public class OpeningStockCsvUploadService {

	private final Logger log = LoggerFactory.getLogger(OpeningStockCsvUploadService.class);
...
//		List<String> pgNames = priceLevelAccountProductGroupDTOs
//				.stream()
...
//					priceLevelAccountProductGroup.setPid(
//							PriceLevelAccountProductGroupService.PID_PREFIX + RandomUtil.generatePid());
...
//				.bulkPriceLevelAccountProductGroups(savePriceLevelAccountProductGroup);
//
//		long end = System.nanoTime();
//		double elapsedTime = (end - start) / 1000000.0;
//		// update sync table
