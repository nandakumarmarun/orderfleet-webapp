 ...
 */
@Service
public class EmployeeProfileAoneUploadService {

	private final Logger log = LoggerFactory.getLogger(EmployeeProfileAoneUploadService.class);
	...
	public EmployeeProfileAoneUploadService(SyncOperationRepository syncOperationRepository) {
		super();
