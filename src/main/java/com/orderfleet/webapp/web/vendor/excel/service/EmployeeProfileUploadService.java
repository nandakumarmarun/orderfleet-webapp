 ...
 */
@Service
public class EmployeeProfileUploadService {

	private final Logger log = LoggerFactory.getLogger(EmployeeProfileUploadService.class);
	...
	public EmployeeProfileUploadService(SyncOperationRepository syncOperationRepository) {
		super();
