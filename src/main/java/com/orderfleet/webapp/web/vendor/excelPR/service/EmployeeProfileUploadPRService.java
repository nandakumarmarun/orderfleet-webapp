 ...
 */
@Service
public class EmployeeProfileUploadPRService {

	private final Logger log = LoggerFactory.getLogger(EmployeeProfileUploadPRService.class);
	...
	public EmployeeProfileUploadPRService(SyncOperationRepository syncOperationRepository) {
		super();
