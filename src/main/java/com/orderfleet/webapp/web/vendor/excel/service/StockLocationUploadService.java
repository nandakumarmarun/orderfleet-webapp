 ...
 */
@Service
public class StockLocationUploadService {

	private final Logger log = LoggerFactory.getLogger(StockLocationUploadService.class);
	...
	public StockLocationUploadService(BulkOperationRepositoryCustom bulkOperationRepositoryCustom,
	...
	public void saveUpdateAccountProfileClosingBalances(final List<AccountProfileDTO> accountProfileDTOs,
		...
		List<AccountProfile> accountProfiles =
				accountProfileRepository.findByCompanyId(companyId);
		  String flag = "Normal";
			LocalDateTime endLCTime = LocalDateTime.now();
			String endTime = endLCTime.format(DATE_TIME_FORMAT);
			String endDate = startLCTime.format(DATE_FORMAT);
