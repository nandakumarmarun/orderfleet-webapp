 ...
 */
@Service
public class AccountProfileUploadServiceCochinDistributors {

	private final Logger log = LoggerFactory.getLogger(AccountProfileUploadServiceCochinDistributors.class);
	...
	public AccountProfileUploadServiceCochinDistributors(BulkOperationRepositoryCustom bulkOperationRepositoryCustom,
	...
	public void saveUpdateAccountProfiles(final List<AccountProfileDTO> accountProfileDTOs,
		...
		if (minutes > 10) {
			flag = "Dead Slow";
				...
				+ description);log.info("Default Account type 123456:" + defaultAccountType.getName());
