 ...
 */
@Service
public class AccountProfileUploadServicePravesh {

	private final Logger log = LoggerFactory.getLogger(AccountProfileUploadServicePravesh.class);
	...
	public AccountProfileUploadServicePravesh(BulkOperationRepositoryCustom bulkOperationRepositoryCustom,
