package com.orderfleet.webapp.web.vendor.UncleJhoneChennai.ChennaiDepot.Services;
...
@Service
public class ChennaiAccountsUploadService {
	String PID_PREFIX = "DDA-";

	final String FACTORY_CODE ="KC";
	final String FACTORY_NAME = "CHENNAI DEPOT";

	private final Logger log = LoggerFactory.getLogger(ChennaiAccountsUploadService.class);
	...
	public ChennaiAccountsUploadService(BulkOperationRepositoryCustom bulkOperationRepositoryCustom,
