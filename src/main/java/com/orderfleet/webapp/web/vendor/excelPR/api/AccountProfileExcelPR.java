package com.orderfleet.webapp.web.vendor.excelPR.api;
...
import com.orderfleet.webapp.web.vendor.excelPR.service.AccountProfileUploadPRService;

@RestController
@RequestMapping(value = "/api/excelPR/v1")
public class AccountProfileExcelPR {

	private final Logger log = LoggerFactory.getLogger(AccountProfileExcelPR.class);
	...
	@Inject
	private AccountProfileUploadPRService accountProfileUploadService;
