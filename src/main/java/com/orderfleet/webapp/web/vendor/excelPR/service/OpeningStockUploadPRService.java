 ...
 */
@Service
public class OpeningStockUploadPRService {

	private final Logger log = LoggerFactory.getLogger(OpeningStockUploadPRService.class);
	...
	public OpeningStockUploadPRService(BulkOperationRepositoryCustom bulkOperationRepositoryCustom,
