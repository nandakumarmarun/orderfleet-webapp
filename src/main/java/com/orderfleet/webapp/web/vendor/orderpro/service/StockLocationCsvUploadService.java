 ...
 */
@Service
public class StockLocationCsvUploadService {

	private final Logger log = LoggerFactory.getLogger(StockLocationCsvUploadService.class);
	...
	public StockLocationCsvUploadService(BulkOperationRepositoryCustom bulkOperationRepositoryCustom,
