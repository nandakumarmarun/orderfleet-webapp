...
@Service
public class UjKuppamAccountService {

    String PID_PREFIX = "DDA-";

    final String FACTORY_CODE ="UP";

    final String FACTORY_NAME = "KUPPAM DEPOT";
    ...
    public UjKuppamAccountService(BulkOperationRepositoryCustom bulkOperationRepositoryCustom,
