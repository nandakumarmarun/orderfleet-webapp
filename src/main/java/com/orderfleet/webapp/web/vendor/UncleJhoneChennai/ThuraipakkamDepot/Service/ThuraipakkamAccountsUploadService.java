package com.orderfleet.webapp.web.vendor.UncleJhoneChennai.ThuraipakkamDepot.Service;
...
@Service
public class ThuraipakkamAccountsUploadService {
	String PID_PREFIX = "TU-";

	final String FACTORY_CODE ="TU";

	final String FACTORY_NAME = "THURAIPAKKAM DEPOT";



	private final Logger log = LoggerFactory.getLogger(ThuraipakkamAccountsUploadService.class);
	...
	public ThuraipakkamAccountsUploadService(BulkOperationRepositoryCustom bulkOperationRepositoryCustom,
