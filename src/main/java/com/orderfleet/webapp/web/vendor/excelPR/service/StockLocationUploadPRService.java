 ...
 */
@Service
public class StockLocationUploadPRService {

	private final Logger log = LoggerFactory.getLogger(StockLocationUploadPRService.class);
	...
	public StockLocationUploadPRService(BulkOperationRepositoryCustom bulkOperationRepositoryCustom,
