package com.orderfleet.webapp.web.vendor.ujkuppam.controller;
...
import com.orderfleet.webapp.web.vendor.ujkuppam.service.UjKuppamAccountService;
import com.orderfleet.webapp.web.vendor.ujkuppam.service.UjKuppamProductService;
...
@Controller
@RequestMapping("/web")
public class UjKuppamResource {
    private final Logger log = LoggerFactory.getLogger(UploadUncleJohnResource.class);

    @Inject
    private UjKuppamProductService ujKuppamProductService;

    @Inject
    private UjKuppamAccountService ujKuppamAccountService;
     ...
     */
    @RequestMapping(value = "/upload-uncleJhon-kuppam", method = RequestMethod.GET)
    @Timed
    ...
    public String uploadXls(Model model) throws URISyntaxException {
        ...
        return "company/uploadUncleJhonKuppam";
    }
     ...
     */
    @RequestMapping(value = "/upload-uncleJhon-kuppam/upload-product-profiles",
     ...
     * @throws ParseException    If there is an issue parsing the response.
     */
    @RequestMapping(value = "/upload-uncleJhon-kuppam/upload-account-profiles",
            method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
