package com.orderfleet.webapp.web.vendor.excelPR;
...
@RestController
@RequestMapping(value = "/api/excelPR/v1")
public class SalesDataDownloadControllerPR {

	private final Logger log = LoggerFactory.getLogger(SalesDataDownloadControllerPR.class);
