 ...
 */
@Service
public class AccountProfileUploadPRService {

	private final Logger log = LoggerFactory.getLogger(AccountProfileUploadPRService.class);
	...
	public AccountProfileUploadPRService(BulkOperationRepositoryCustom bulkOperationRepositoryCustom,
