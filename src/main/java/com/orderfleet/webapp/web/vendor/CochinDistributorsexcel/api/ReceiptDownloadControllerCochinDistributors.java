...
public class ReceiptDownloadControllerCochinDistributors {

	private final Logger log = LoggerFactory.getLogger(ReceiptDownloadControllerCochinDistributors.class);
