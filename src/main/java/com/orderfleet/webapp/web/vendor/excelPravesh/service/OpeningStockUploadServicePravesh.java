package com.orderfleet.webapp.web.vendor.excelPravesh.service;
 ...
 */
@Service
public class OpeningStockUploadServicePravesh {

	private final Logger log = LoggerFactory.getLogger(OpeningStockUploadServicePravesh.class);
	...
	public OpeningStockUploadServicePravesh(BulkOperationRepositoryCustom bulkOperationRepositoryCustom,
	...
	public void saveUpdateOpeningStock(final List<OpeningStockDTO> openingStockDTOs,
		...
		Set<String> ppName = openingStockDTOs.stream().map(os -> os.getProductProfileName())
		...
		List<ProductProfile> productProfiles = productProfileRepository
				.findByCompanyIdAndNameIgnoreCaseIn(company.getId(), ppName);
