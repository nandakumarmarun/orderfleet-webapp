 ...
 * @since June 10, 2020
 */
public class DocumentEcomProductGroupDTO {
	...
	public DocumentEcomProductGroupDTO() {
		super();
	}

	public DocumentEcomProductGroupDTO(DocumentEcomProductGroup documentProductGroup) {
		super();
