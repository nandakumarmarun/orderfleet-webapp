...
public class InvoiceWiseReportDetailView {
	...
	public InvoiceWiseReportDetailView(String pid, String documentName, double documentTotal,
			String documentType) {
		super();
		this.pid = pid;
	...
	public InvoiceWiseReportDetailView(String pid, String documentName, String documentType, boolean imageSaved) {
		super();
		this.pid = pid;
		this.documentName = documentName;
		this.documentType = documentType;
