...
public class ProductGroupMapperImpl extends ProductGroupMapper {
	...
	public ProductGroupDTO productGroupToProductGroupDTODescription(ProductGroup productGroup) {
		...
		productGroupDTO.setPid(productGroup.getPid());
		productGroupDTO.setName(
				productGroup.getDescription() != null && !productGroup.getDescription().equalsIgnoreCase("common")
	...
	public List<ProductGroupDTO> productGroupsToProductGroupDTOs(List<ProductGroup> productGroups) {
		...
		if (getCompanyCofig()) {
			for (ProductGroup productGroup : productGroups) {
				list.add(productGroupToProductGroupDTODescription(productGroup));
			}
		} else {
			for (ProductGroup productGroup : productGroups) {
	...
	private String productGroupName(ProductGroup productGroup) {
		if (productGroup.getDescription() != null && getCompanyCofig()
				&& !productGroup.getDescription().equals("common")) {
