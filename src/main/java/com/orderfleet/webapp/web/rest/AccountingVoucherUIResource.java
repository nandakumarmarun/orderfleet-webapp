...
public class AccountingVoucherUIResource {
	...
	public @ResponseBody List<AccountingVoucherUIDTO> getAccountingVoucher(
		 ...
		 DateTimeFormatter DATE_TIME_FORMAT = DateTimeFormatter.ofPattern("hh:mm:ss a");
			...
			String id = "AVD_QUERY_109" + "_" + SecurityUtils.getCurrentUserLogin() + "_" + LocalDateTime.now();
			String description ="get all by compId account paymentmode and accVoucher headerPid";
