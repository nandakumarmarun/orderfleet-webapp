...
public class AccountingVoucherDetailDTO {
	...
	private List<AccountingVoucherAllocationDTO> accountingVoucherAllocations;
	...
	public AccountingVoucherDetailDTO(AccountingVoucherDetail accountingVoucherDetail) {
		...
		if (accountingVoucherDetail.getAccountingVoucherAllocations() != null) {
			this.accountingVoucherAllocations = accountingVoucherDetail.getAccountingVoucherAllocations().stream()
					.map(AccountingVoucherAllocationDTO::new).collect(Collectors.toList());
		}
	...
	public List<AccountingVoucherAllocationDTO> getAccountingVoucherAllocations() {
		return accountingVoucherAllocations;
	}

	public void setAccountingVoucherAllocations(List<AccountingVoucherAllocationDTO> accountingVoucherAllocations) {
