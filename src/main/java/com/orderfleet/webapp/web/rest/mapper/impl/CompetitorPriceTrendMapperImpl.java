...
public class CompetitorPriceTrendMapperImpl extends CompetitorPriceTrendMapper{
	 ...
	 @Override
	    public CompetitorPriceTrendDTO competitorPriceTrendToCompetitorPriceTrendDTO(CompetitorPriceTrend competitorPriceTrend) {
	        ...
	        competitorPriceTrendDTO.setPriceTrendProductName( competitorPriceTrendPriceTrendProductName( competitorPriceTrend ) );
	        competitorPriceTrendDTO.setPriceTrendProductGroupName( competitorPriceTrendPriceTrendProductGroupName( competitorPriceTrend ) );
	        competitorPriceTrendDTO.setPriceTrendProductGroupPid( competitorPriceTrendPriceTrendProductGroupPid( competitorPriceTrend ) );
	        ...
	        competitorPriceTrendDTO.setCompetitorProfileName( competitorPriceTrendCompetitorProfileName( competitorPriceTrend ) );
	    ...
	    @Override
	    public List<CompetitorPriceTrendDTO> competitorPriceTrendsToCompetitorPriceTrendDTOs(List<CompetitorPriceTrend> competitorPriceTrends) {
	    ...
	    @Override
	    public CompetitorPriceTrend competitorPriceTrendDTOToCompetitorPriceTrend(CompetitorPriceTrendDTO competitorPriceTrendDTO) {
	    ...
	    @Override
	    public List<CompetitorPriceTrend> competitorPriceTrendDTOsToCompetitorPriceTrends(List<CompetitorPriceTrendDTO> competitorPriceTrendDTOs) {
