...
import com.orderfleet.webapp.web.rest.integration.TallyClientAppResource.Service.TallyReceivablePayabaleService;
...
public class TallyReceivablePayabalesResource {

    private final Logger log = LoggerFactory.getLogger(TallyReceivablePayabalesResource.class);

    @Inject
    private SyncOperationRepository syncOperationRepository;

    @Inject
    private TallyReceivablePayabaleService tallyReceivablePayabaleService;




    @RequestMapping(value = "/receivable-payableUpdatedIdNew.json",
    ...
    public ResponseEntity<String> bulkSaveReceivablePayables(
        ...
        log.debug("REST request to save Receivable Payable : {}",
                receivablePayableDTOs.size());
        ...
        return syncOperationRepository
            ...
            // save/update
            tallyReceivablePayabaleService
                    .saveUpdateReceivablePayablesUpdateIdNew(
                            receivablePayableDTOs,
                            so);
