...
public class AccountTypeMapperImpl extends AccountTypeMapper {
	...
	public AccountTypeDTO accountTypeToAccountTypeDTODescription(AccountType accountType) {
		if (accountType == null) {
			return null;
		}
		...
		accountTypeDTO.setName(
				accountType.getDescription() != null && !accountType.getDescription().equalsIgnoreCase("common")
	...
	public List<AccountTypeDTO> accountTypesToAccountTypeDTOs(List<AccountType> accountTypes) {
		...
		if (getCompanyCofig()) {
			for (AccountType accountType : accountTypes) {
				list.add(accountTypeToAccountTypeDTODescription(accountType));
			}
		} else {
			for (AccountType accountType : accountTypes) {
