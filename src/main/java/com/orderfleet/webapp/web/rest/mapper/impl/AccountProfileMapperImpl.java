...
@Override
	    public AccountProfileDTO accountProfileToAccountProfileDTO(AccountProfile accountProfile) {
	        ...
	        accountProfileDTO.setName(accountProfileName(accountProfile) );
	...
	@Override
       ...
       @Override
	    ...
	    private String accountProfileDefaultPriceLevelName(AccountProfile accountProfile) {
	        ...
	        if(defaultPriceLevel.getDescription()!=null && getCompanyCofig() && !defaultPriceLevel.getDescription().equals("common")) {
