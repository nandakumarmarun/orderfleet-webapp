...
public class ReceivablePayableMapperImpl extends ReceivablePayableMapper {
	...
	@Override
	public List<ReceivablePayableDTO> receivablePayablesToReceivablePayableDTOs(
			List<ReceivablePayable> productCategories) {
	...
	@Override
	public List<ReceivablePayable> receivablePayableDTOsToProductCategories(
