...
public final class SecurityUtils {
	...
	/**
	 * Return the current user's company id, or throws an exception, if the user
	 * is not authenticated yet.
	 * 
	 * @return the current user's company id
	 */
	public static Long getCurrentUsersCompanyId() {
