...
import com.orderfleet.webapp.repository.PersistentTokenRepository;
...
public class PersistentTokenRememberMeServices extends
    ...
    public PersistentTokenRememberMeServices(OrderfleetProperties orderfleetProperties,
            org.springframework.security.core.userdetails.UserDetailsService userDetailsService,
            PersistentTokenRepository persistentTokenRepository, UserRepository userRepository) {

        super(orderfleetProperties.getSecurity().getRememberMe().getKey(), userDetailsService);
